...
$$
x' = \frac{R^{2}x}{r^{2}}, \quad y' = \frac{R^{2}y}{r^{2}}, \quad r^{2} = x^{2}+y^{2}
$$
$$
...
\end{vmatrix}dA \\
&= \begin{vmatrix}
\frac{ \partial  }{ \partial x } \left(\frac{xR^{2}}{x^{2}+y^{2}}\right) & \frac{ \partial  }{ \partial y } \left(\frac{xR^{2}}{x^{2}+y^{2}}\right) \\
\frac{ \partial  }{ \partial x } \left(\frac{yR^{2}}{x^{2}+y^{2}}\right) & \frac{ \partial  }{ \partial y } \left(\frac{yR^{2}}{x^{2}+y^{2}}\right)
\end{vmatrix}dA \\
&= \begin{vmatrix}
